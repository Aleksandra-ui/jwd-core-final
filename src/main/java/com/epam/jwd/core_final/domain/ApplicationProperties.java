 ...
 * Expected fields:
 * <p>
 * inputRootDir {@link String} - base dir for all input files outputRootDir
 * {@link String} - base dir for all output files crewFileName {@link String}
 * missionsFileName {@link String} spaceshipsFileName {@link String}
 * <p>
 * fileRefreshRate {@link Integer} dateTimeFormat {@link String} - date/time
 * format for {@link java.time.format.DateTimeFormatter} pattern
 */
public class ApplicationProperties {
	...
	public static ApplicationProperties newInstance(String inputRootDir, String outputRootDir, String crewFileName,
			...
			String spacemapFileName) {
		if (instance == null) {
			instance = new ApplicationProperties(inputRootDir, outputRootDir, crewFileName, missionsFileName,
